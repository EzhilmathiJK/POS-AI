  ...
  return (
    <div className="h-full bg-[var(--color-orange-action)] text-white rounded-[4px] overflow-hidden">
      ...
      <div className="grid grid-cols-3 grid-rows-2 h-full xl:hidden">
        <button className="flex flex-col items-center justify-center gap-[4px] hover:bg-[#ed8f2c] transition-colors border-r border-b border-[var(--color-orange-action-border)]">
        ...
        <button className="flex flex-col items-center justify-center gap-[4px] hover:bg-[#ed8f2c] transition-colors">
