...
const PriceAmendment = ({ totalAmount, gstAmount, payable }) => {
  ...
  return (
    <div className="bg-white rounded-[7px] flex-1 flex flex-col min-h-0 pt-[18px] pb-[14px]">
      <div className="px-[17px] pb-[18px] flex items-center gap-[10px] border-b border-[var(--color-border)]">
      ...
      <div className="px-[30px] pt-[15px] pb-[10px] space-y-[14px]">
      ...
      <div className="mx-[17px] px-[13px] py-[10px] border-t border-b border-[var(--color-border)]">
      ...
      <div className="px-[30px] pt-[16px] flex items-center justify-between">
